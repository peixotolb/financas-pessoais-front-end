                    ...
                    <div className="col-lg-6">
                        <div className="bs-component">
                            ...
                            <FormGroup label="Mês: *" htmlFor="inpuMes">
                                <SelectMenu id="inpuMes" className="form-control" 
                                            value={this.state.mes} 
                                            onChange={e => this.setState({mes: e.target.value})}
                                            lista={meses} />
                            </FormGroup>
                            <FormGroup label="Desrição: " htmlFor="inputDescricao">
                                <input type="text" className="form-control" id="inputDescricao" 
                                        value={this.state.descricao}
                                        onChange={e => this.setState({descricao: e.target.value})}
                                        placeholder="Digite a descrição" />
                            </FormGroup>
                            <FormGroup label="Tipo de Lançamento: *" htmlFor="inpuTipo">
                                <SelectMenu id="inpuTipo" className="form-control" 
